...
namespace SmartQQ.Core.Client
{
    ...
    public class SmartQQClient
    {
        ...
        internal static readonly ILog Logger = LogManager.GetLogger(typeof(SmartQQClient));
        ...
        public LoginResult Start(Action<string> qrCodeDownloadedCallback) => Start(_ =>
        {
            ...
            //filePath = System.IO.Directory.GetCurrentDirectory() + "/Resource/ptqrshow.png";
            filePath = System.IO.Directory.GetCurrentDirectory() + "/Resource/ptqrshow.png";
